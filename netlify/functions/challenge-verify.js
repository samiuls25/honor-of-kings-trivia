...
export default async (request) => {
  ...
  params.set('advance', String(payload?.advance ?? ''))
  params.set('scoring', String(payload?.scoring ?? ''))
  params.set('customLimit', String(payload?.customLimit ?? ''))
  params.set('customQuestions', String(payload?.customQuestions ?? ''))
  params.set('customMinutes', String(payload?.customMinutes ?? ''))
